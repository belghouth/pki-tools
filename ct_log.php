...
const CT_KEYS_DIR   = '/var/www/thameur.org/pki-ca/ct-log-keys/';
const CT_ROOT_CRT   = '/var/www/pki.thameur.org/meerkat-root.crt';
const CT_ISSU_CRT   = '/var/www/pki.thameur.org/meerkat-issuing.crt';
const CT_OPENSSL    = '/usr/bin/openssl';
const CT_MAX_CHAIN  = 10; // max certs in submitted chain

// CT poison OID value bytes (tag 0x06 len 0x0a value…)
const POISON_OID_VAL = "\x2b\x06\x01\x04\x01\xd6\x79\x02\x04\x03";

// Pool of fake log identities — key files generated by scripts/gen_ct_log_keys.php
// [description, operator, mmd_seconds]
const CT_LOG_META = [
    'lynx'    => ['Meerkat Lynx CT 2025h1',   'Kablouti Certificate Services',   86400],
    'osprey'  => ['Meerkat Osprey CT 2025h2',  'Karkoub Trust Infrastructure',    86400],
    'kestrel' => ['Meerkat Kestrel CT 2026h1', 'Sal7ouf Digital Logs',            86400],
    'merlin'  => ['Meerkat Merlin CT 2025',    'Farhoud CT Authority',            86400],
    'harrier' => ['Meerkat Harrier CT 2026',   'Habhoub Certificate Logs',        86400],
    'falcon'  => ['Meerkat Falcon CT 2025h2',  'Sardouk Log Services',            86400],
    'ibis'    => ['Meerkat Ibis CT 2026h1',    'Dhibi Digital Trust',             86400],
    'wren'    => ['Meerkat Wren CT 2025',      'Bousannoun Certificate Transparency', 86400],
];
...
function load_random_log(): array
{
    ...
    foreach ($names as $name) {
        $kf = CT_KEYS_DIR . $name . '.pem';
        $if = CT_KEYS_DIR . $name . '.id';
...
{
    $certs = [];
    foreach ([CT_ROOT_CRT, CT_ISSU_CRT] as $f) {
